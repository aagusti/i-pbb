...
def view_home(request):
    if authenticated_userid(request):
        return HTTPFound(location=request.route_url('home-auth'))
    ...
    if 'login' in request.POST: 
        ...
        return r
    return dict(project='i-pbb', form=form.render())

@view_config(route_name='home-auth', renderer='templates/home_auth.pt',
             permission="view")
